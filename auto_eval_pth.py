...
def write_new_table(file_path, original_data, mse_mad_results, header_info):
    ...
    try:
        with open(file_path, 'w', encoding='utf-8') as f:
            ...
            f.write("-" * 127 + "\n")
            # 写入表头
            # f.write("|  Epoch   |    SOC Semantic Loss     |     SOC Detail Loss      |         MSE          |         MAD          |\n")
            ...
            for i, row in enumerate(original_data):
                ...
                # f.write(f"|    {epoch:<5} |       {row['SOC Semantic Loss']:<11.6f}    |       {row['SOC Detail Loss']:<11.6f}    |")
...
def main(json_path=None):
    # 配置路径
    model_dir = "./model_save/pruned_once_modified_rep_hr_layer_learnableparam_separate"
    results_file = "training_results/20250409_150702_pruned_once_rep_hr1layer_learnableparam_separate修改后.txt"
