...
if __name__ == '__main__':
    ...
    # json文件路径
    prune_info_path = "D:\\MODNet-ModelCompression\\result\\prune\\modify_mppm_prune_once\\modnet_p_new_trimap_0027_lr0.0001_ratio_0.5_thresh_0.4.json"
    # 剪枝后模型路径
    ckp_pth = "D:\\MODNet-ModelCompression\\model_save\\pruned_once_modified_yuanban\\new_trimap_0095_lr1e-05.pth"
