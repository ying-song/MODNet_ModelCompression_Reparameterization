...
def run(pretrained_path, ratio, threshold, weight_replace=False, verbose=True, save_dir='./result/prune/1/'):
    """
    Pruning pipeline
    ...
    modnet.load_state_dict({k.replace('module.', ''): v for k, v in torch.load(pretrained_path).items()}, strict=True)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--ckpt_path', type=str, default='./pretrained/modify_mppm_modnet.ckpt', required=False,
