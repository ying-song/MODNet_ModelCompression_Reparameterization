...
from .repmobilenetv2_auto import RepMobileNetV2Auto
...
class RepMobileNetV2BackboneAuto(BaseBackboneAuto):
    """ MobileNetV2 Auto Backbone
    """

    def __init__(self, in_channels, cfg, expansion_cfg):
        super(RepMobileNetV2BackboneAuto, self).__init__(in_channels, cfg, expansion_cfg)

        # self.model = RepMobileNetV2Auto(self.in_channels, self.cfg, self.expansion_cfg, num_classes=None)
        self.model = RepMobileNetV2Auto(self.in_channels, self.cfg, self.expansion_cfg, num_classes=None)
