...
if __name__ == '__main__':
    ...
    parser.add_argument('--model-path', type=str, default='./result/prune/rep_ratio_0.5_thresh_0.5_2/modnet_p_new_trimap_0027_lr0.0001_ratio_0.5_thresh_0.5.ckpt', required=False, 
