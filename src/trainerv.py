...
viz = Visdom()
logging.basicConfig(filename='./my_log/rep_m_p_n_t_0027_lr0.0001_r_0.5_t_0.5_train.log', level=logging.INFO, datefmt='%Y-%m-%d %H:%M:%S')
logging.info('------------------------------------')
...
if __name__ == '__main__':
    ...
    parser.add_argument('--model-path', type=str, default='./pth_to_ckpt/modify1layer_rep_m_p_n_t_0027_lr0.0001_r_0.5_t_0.5/new_trimap_0014_lr0.001.ckpt', required=False, 
